...
const Navbar = () => {
    ...
    if (sessionStorage.length === 0) {
        return (
            <nav className="navbar navbar-expand-lg navbar-light py-3 sticky-top" id='Navbar-color'>
                <div className="container">
                    <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/"> WalkWell-Step Into Style </NavLink>
